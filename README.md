...
A shell emulator faithful enough to put behind an SSH honeypot, with **185
...
| | |
|---|---:|
| Emulator | 43,036 lines |
| Commands | 349 |
| Suites | 185 |
| Test code | 49,536 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 43,036 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 185 suites and the one question each asks. It is
