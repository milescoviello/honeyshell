...
A shell emulator faithful enough to put behind an SSH honeypot, with **159
...
| | |
|---|---:|
| Emulator | 38,936 lines |
| Commands | ~365 |
| Suites | 159 |
| Test code | 43,927 lines |

## What is in here

| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 38,936 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 159 suites and the one question each asks.
