...
A shell emulator faithful enough to put behind an SSH honeypot, with **155
...
| | |
|---|---:|
| Emulator | 38,602 lines |
| Commands | ~365 |
| Suites | 155 |
| Test code | 43,080 lines |

## What is in here

| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 38,602 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 155 suites and the one question each asks.
