...
A shell emulator faithful enough to put behind an SSH honeypot, with **197
...
| | |
|---|---:|
| Emulator | 44,830 lines |
| Commands | 352 |
| Suites | 197 |
| Test code | 51,754 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 44,830 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 197 suites and the one question each asks. It is
