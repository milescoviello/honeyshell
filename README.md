...
A shell emulator faithful enough to put behind an SSH honeypot, with **193
...
| | |
|---|---:|
| Emulator | 44,474 lines |
| Commands | 351 |
| Suites | 193 |
| Test code | 50,937 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 44,474 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 193 suites and the one question each asks. It is
