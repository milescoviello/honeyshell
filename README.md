...
A shell emulator faithful enough to put behind an SSH honeypot, with **176
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 40,596 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 176 suites and the one question each asks. It is
