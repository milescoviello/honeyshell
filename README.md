...
A shell emulator faithful enough to put behind an SSH honeypot, with **171
...
| | |
|---|---:|
| Emulator | 39,937 lines |
| Commands | 348 |
| Suites | 171 |
| Test code | 46,342 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 39,937 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 171 suites and the one question each asks. It is
