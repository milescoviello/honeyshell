...
A shell emulator faithful enough to put behind an SSH honeypot, with **180
...
| | |
|---|---:|
| Emulator | 42,163 lines |
| Commands | 349 |
| Suites | 180 |
| Test code | 48,549 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 42,163 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 180 suites and the one question each asks. It is
