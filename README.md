...
A shell emulator faithful enough to put behind an SSH honeypot, with **172
...
| | |
|---|---:|
| Emulator | 40,002 lines |
| Commands | 348 |
| Suites | 172 |
| Test code | 46,501 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 40,002 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 172 suites and the one question each asks. It is
