...
A shell emulator faithful enough to put behind an SSH honeypot, with **170
...
| | |
|---|---:|
| Emulator | 39,857 lines |
| Commands | 348 |
| Suites | 170 |
| Test code | 46,153 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 39,857 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 170 suites and the one question each asks. It is
