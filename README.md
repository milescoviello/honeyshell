...
A shell emulator faithful enough to put behind an SSH honeypot, with **160
...
| | |
|---|---:|
| Emulator | 39,070 lines |
| Commands | ~365 |
| Suites | 160 |
| Test code | 44,098 lines |

## What is in here

| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 39,070 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 160 suites and the one question each asks.
