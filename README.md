...
A shell emulator faithful enough to put behind an SSH honeypot, with **158
...
| | |
|---|---:|
| Emulator | 38,840 lines |
| Commands | ~365 |
| Suites | 158 |
| Test code | 43,733 lines |

## What is in here

| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 38,840 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 158 suites and the one question each asks.
