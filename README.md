...
A shell emulator faithful enough to put behind an SSH honeypot, with **181
...
| | |
|---|---:|
| Emulator | 42,308 lines |
| Commands | 349 |
| Suites | 181 |
| Test code | 48,780 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 42,308 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 181 suites and the one question each asks. It is
