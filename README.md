...
A shell emulator faithful enough to put behind an SSH honeypot, with **194
...
| | |
|---|---:|
| Emulator | 44,589 lines |
| Commands | 352 |
| Suites | 194 |
| Test code | 51,114 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 44,589 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 194 suites and the one question each asks. It is
