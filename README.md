...
A shell emulator faithful enough to put behind an SSH honeypot, with **195
...
| | |
|---|---:|
| Emulator | 44,637 lines |
| Commands | 352 |
| Suites | 195 |
| Test code | 51,271 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 44,637 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 195 suites and the one question each asks. It is
