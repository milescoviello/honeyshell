...
A shell emulator faithful enough to put behind an SSH honeypot, with **154
...
| | |
|---|---:|
| Emulator | 38,500 lines |
| Commands | ~365 |
| Suites | 154 |
| Test code | 42,871 lines |

## What is in here

| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 38,500 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 154 suites and the one question each asks.
