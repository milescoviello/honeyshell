...
A shell emulator faithful enough to put behind an SSH honeypot, with **184
...
| | |
|---|---:|
| Emulator | 42,998 lines |
| Commands | 349 |
| Suites | 184 |
| Test code | 49,400 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 42,998 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 184 suites and the one question each asks. It is
