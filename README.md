...
A shell emulator faithful enough to put behind an SSH honeypot, with **189
...
| | |
|---|---:|
| Emulator | 43,463 lines |
| Commands | 350 |
| Suites | 189 |
| Test code | 50,216 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 43,463 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 189 suites and the one question each asks. It is
