...
A shell emulator faithful enough to put behind an SSH honeypot, with **165
...
| | |
|---|---:|
| Emulator | 39,431 lines |
| Commands | 348 |
| Suites | 165 |
| Test code | 45,243 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 39,431 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 165 suites and the one question each asks. It is
