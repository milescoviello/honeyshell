...
A shell emulator faithful enough to put behind an SSH honeypot, with **186
...
| | |
|---|---:|
| Emulator | 43,070 lines |
| Commands | 349 |
| Suites | 186 |
| Test code | 49,697 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 43,070 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 186 suites and the one question each asks. It is
