...
A shell emulator faithful enough to put behind an SSH honeypot, with **188
...
| | |
|---|---:|
| Emulator | 43,157 lines |
| Commands | 349 |
| Suites | 188 |
| Test code | 50,023 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 43,157 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 188 suites and the one question each asks. It is
