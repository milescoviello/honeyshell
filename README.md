...
A shell emulator faithful enough to put behind an SSH honeypot, with **175
...
| | |
|---|---:|
| Emulator | 40,242 lines |
| Commands | 348 |
| Suites | 175 |
| Test code | 47,155 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 40,242 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 175 suites and the one question each asks. It is
