...
A shell emulator faithful enough to put behind an SSH honeypot, with **190
...
| | |
|---|---:|
| Emulator | 44,098 lines |
| Commands | 350 |
| Suites | 190 |
| Test code | 50,393 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 44,098 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 190 suites and the one question each asks. It is
