...
A shell emulator faithful enough to put behind an SSH honeypot, with **163
...
| | |
|---|---:|
| Emulator | 39,285 lines |
| Commands | 365 |
| Suites | 163 |
| Test code | 44,791 lines |
...
| File | Lines | Job |
|---|---:|---|
| `fakeshell.py` | 39,285 | The emulator: the VFS, the shell language, and every command |
...
`SUITES.md` lists all 163 suites and the one question each asks. It is
